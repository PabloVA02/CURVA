...
- **La app de Curva**, compilada desde `prototipo-microaprendizaje` con
  ...
  `docs/assets/index-BEVu28m-.js`, y lleva los 288 libros con el texto de Pablo.
...
está guardado aquí al lado, entero y con los 288 libros dentro.

Para que la raíz vuelva a servir la app, basta cambiar esa línea del `<head>`:

    <script type="module" crossorigin src="./assets/index-BEVu28m-.js"></script>
