...
**Estado a 19 de septiembre de 2026.**
...
- **La app de Curva**, compilada desde `prototipo-microaprendizaje` con
  ...
  `docs/assets/index-CtIMkUnl.js`, y lleva los 161 libros con el texto de Pablo.
...
está guardado aquí al lado, entero y con los 161 libros dentro.

Para que la raíz vuelva a servir la app, basta cambiar esa línea del `<head>`:

    <script type="module" crossorigin src="./assets/index-CtIMkUnl.js"></script>
