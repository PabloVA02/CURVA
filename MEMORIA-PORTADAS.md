...
Antes de trabajar en cualquier portada de Curva, recuperar estas fuentes:

1. [Prompt maestro vigente](referencias/portadas/sistema-2026-09-21/Prompt-maestro.md).
2. [Análisis de las referencias y ajustes](referencias/portadas/sistema-2026-09-21/Analisis.md).
3. [Referencias originales y archivo del sistema](referencias/portadas/sistema-2026-09-21/LEEME.md).
4. [Preferencias e historial del usuario](referencias/portadas/Preferencias-del-usuario.md).
...
Diagnóstico profundo posterior, solicitado expresamente: leer `referencias/portadas/comparacion-2026-09-21/Diagnostico-profundo.md` antes del siguiente encargo. Sus ejemplos señalados están en `docs/analisis-portadas.html`. Corregir el proceso: resolver una relación visual específica y la composición completa antes de detallar objetos; evitar por defecto letras ultra pesadas y condensadas; no tratar un fallo estructural como un simple problema de sombreado. Las correcciones con imágenes deben apoyarse en referencias pertinentes cuando corresponda. La armonía depende del grado de abstracción, de las relaciones entre formas y del peso del texto, además del color. El documento distingue observaciones e inferencias y no modifica las portadas existentes.
