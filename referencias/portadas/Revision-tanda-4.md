# Revisión de la cuarta tanda de Curva

- 16 portadas originales vinculadas a 16 identificadores existentes del catálogo que no tenían portada asignada.
- Cada cubierta tiene un título, un mensaje explicativo basado en la fuente editorial enlazada, dibujos de colores vivos y la doblez vertical izquierda.
- Revisión visual de las 16 imágenes originales: letras, tildes, caras, ojos, manos, anatomía ilustrada y composición.
- Archivos de 1024 × 1536 píxeles. Las versiones WebP de la app conservan exactamente los píxeles de los PNG originales.
...
[Catálogo de la tanda](portadas-tanda-4.json) · [Historial y prompts](historial/README.md) · [Fuentes del contenido](Fuentes-tanda-4.md)
