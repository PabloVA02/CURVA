...
El criterio vigente del 19 de septiembre de 2026 pide dibujos editoriales bonitos, coloridos y muy variados; variar tipografía, tamaño, color y posición del título y del mensaje en cada diseño. El mensaje debe explicar el libro con fuentes verificadas y leerse en móvil. Conservar la doblez lateral y un contorno blanco normal, muy fino y continuo, incluidas las esquinas. El usuario rechazó el canto de páginas y el volumen 3D probado ese día.

Crear portadas únicamente para libros sin cubierta propia, excluyendo los reservados para otra IA. Conservar todas las imágenes mostradas, incluidas correcciones y descartes, con sus prompts y procedencia.
