...
Petición vigente del 21 de septiembre: mostrar únicamente libros con páginas de resumen; conservar el resto de datos y archivos sin mostrarlos en la app. Quitar etiquetas de procedencia («Claude») y recuentos del catálogo. Hay seis nuevas portadas de deportes pendientes; el usuario dará las instrucciones de diseño. No generar ni instalar esas portadas hasta recibirlas. Ver `referencias/libros/publicacion-361-2026-09-21/`.
